...
class PostAllClozeTestlAnswers(object):
    ...
    def post_all_clozeTest_answer(self, taskID, user_answer):
        url = "{}/userReading/{}/saveclozeTestAnswer".format(self.baseUrl, taskID)
        data = user_answer
        print(user_answer)

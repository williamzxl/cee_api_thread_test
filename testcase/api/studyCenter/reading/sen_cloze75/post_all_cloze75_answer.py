...
class PostAllCloze75lAnswers(object):
    ...
    def post_all_cloze75_answer(self, taskID, user_answer):
        url = "{}/userReading/{}/saveSenClozeAnswer".format(self.baseUrl, taskID)
        data = user_answer
        print(user_answer)

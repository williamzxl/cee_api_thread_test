...
class GetAllSenCloze75Answers(object):
    ...
    def get_all_Cloze75_answer(self, groupID, taskID):
        url = "{}/sysReading/{}/senCloze".format(self.baseUrl, groupID)
    ...
    def get_Cloze75_words(self, groupID, taskID, practiceType):
        url = "{}/sysReading/{}/senCloze".format(self.baseUrl, groupID)
        querystring = {"taskID": "{}".format(taskID)}
        response = requests.request("GET", url, headers=self.headers, params=querystring)
        answer = response.text
    ...
    def get_Cloze75_word_done_data(self, groupID, taskID, practiceType):

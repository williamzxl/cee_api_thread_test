...
class PostAllWordSpellAnswers(object):
    ...
    def post_all_word_spell_answer(self, taskID, user_answer):
        url = "{}/userWriting/{}/saveWordSpellAnswer".format(self.baseUrl, taskID)
        data = user_answer

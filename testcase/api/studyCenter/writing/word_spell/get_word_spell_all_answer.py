...
class GetAllWordSpellAnswers(object):
    ...
    def get_all_word_spell_answer(self, groupID, taskID):
        url = "{}/sysWriting/{}/wordSpell".format(self.baseUrl, str(groupID))
    ...
    def get_word_spell_words(self, groupID, taskID, practiceType):
        url = "{}/sysWriting/{}/wordSpell".format(self.baseUrl, groupID)

...
class GetAllWordDictAnswers(object):
    ...
    def get_all_dict_answer(self, groupID, taskID):
        url = "{}/sysListening/{}/wordDic".format(self.baseUrl, str(groupID))
    ...
    def get_word_dict_words(self, groupID, taskID, practiceType):
        url = "{}/sysListening/{}/wordDic".format(self.baseUrl, groupID)
        ...
        for w in result:
            if w.get("currStatus") == 1:
                star_3 = {"groupID":groupID,"newF":2,"oldF":w.get("familiarity"),"practiceType":practiceType,"sysID":"","taskID":taskID,"wordID":w.get("wordID")}
